<?php include($this->config->item('header')); ?>
	<div class="content">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h4 class="page-title"><?php echo anchor('task/manage/applyment', 'TMS', 'title="Task Management System"');?> <i class="fa fa-angle-double-right"></i> ADD Applyment</h4>
        </div>
      </div>
      <!-- row -->
          ...
          <div class="block">
            ...
            <div class="data-fluid">
            		...
            		<?php if(validation_errors()){echo '<div class="badge-warning">'.validation_errors().'</div>';} ?>
                  	...
                  	<?php echo form_open('task/action/save_applyment', 'class="form-horizontal"'); 
					...
					<div class="row-form">
                        ...
                        <div class="span4 col-sm-4">
                          <?php echo form_textarea("task_report","","class='form-control'"); ?>
						</div>
                    </div>  
					<div class="row-form">
